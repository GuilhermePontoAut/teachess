import { Flag, Handshake, RotateCcw, Shuffle, Undo2 } from "lucide-react";
import { buttonBase } from "./play";

export function MatchControls({ finished, onFlip, onDraw, onResign, onRestart, onBack }: { finished: boolean; onFlip: () => void; onDraw: () => void; onResign: () => void; onRestart: () => void; onBack: () => void }) {
  const controls = [

...
export function AvailablePlayers({ players, selectedId, disabled, onSelect }: { players: AvailablePlayer[]; selectedId: string | null; disabled: boolean; onSelect: (player: AvailablePlayer) => void }) {

...
export const sortRankingPlayers = (players: RankingPlayer[]): RankingPlayer[] => [...players].sort((a, b) => b.currentPlatformRating - a.currentPlatformRating || b.wins - a.wins || b.winRate - a.winRate || a.name.localeCompare(b.name));
